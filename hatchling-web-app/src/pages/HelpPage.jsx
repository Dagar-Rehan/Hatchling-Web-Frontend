...
export default function HelpPage() {
  ...
  const run_button = "When you are finished typing your code and are ready to see it in action, this button will run your code"
  ...
  const grid_switch = "Characters on screen like to move from one place to another by counting their steps. To help see where a character can step to next, you can toggle the grid by pressing the grid button."
